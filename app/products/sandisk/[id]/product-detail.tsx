...
export default function ProductDetail({ product }: ProductDetailProps) {
  ...
  // Dynamically show all specs (all columns except standard ones)
  const standardKeys = [
    "id", "model_name", "name", "description", "storage_type", "capacity", "image_url", "price", "features", "ports", "created_at", "updated_at"
  ];
  const specs = Object.entries(product)
    .filter(([key, value]) => !standardKeys.includes(key) && value !== null && value !== undefined && typeof value !== "object")
    ...
    <div className="min-h-screen bg-[#f8fafc]">
      <div className="container mx-auto px-4 py-16 pt-24">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-8">
          ...
          <span>/</span>
          <Link href="/products/sandisk" className="hover:text-primary">Sandisk</Link>
          <span>/</span>
