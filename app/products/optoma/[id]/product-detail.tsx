    ...
    <div className="min-h-screen bg-[#f8fafc]">
      <div className="container mx-auto px-4 py-16 pt-24">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-8">
          ...
          <span>/</span>
          <Link href="/products/optoma" className="hover:text-primary">Optoma</Link>
          <span>/</span>
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12 bg-white p-6 rounded-xl shadow-lg">
          ...
          <div className="flex flex-col justify-between">
            ...
            <Link href="/products/optoma" className="mt-8 block text-center text-red-700 hover:underline">
