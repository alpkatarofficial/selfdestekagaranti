...
export default function TemizlikUrunleriPage() {
  ...
  useEffect(() => {
    const loadProducts = async () => {
      ...
      const temizlikUrunleriProducts = allProducts.filter((p) => p.category === "temizlik-urunleri")
      setProducts(temizlikUrunleriProducts)
      setIsLoading(false)
    }
    loadProducts()
  }, [])
      ...
      <div className="container mx-auto px-4 py-16 pt-24">
        ...
        <div className="relative mb-16 rounded-2xl overflow-hidden">
          <div className="absolute inset-0">
            <Image
              src="/images/dreame-carpet-cleaner.webp"
              alt="Dreame Temizlik Ürünleri"
              fill
          ...
          <div className="relative z-10 text-center py-24 px-8">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 text-white drop-shadow-lg">Dreame Temizlik Ürünleri</h1>
            <p className="text-xl md:text-2xl text-gray-100 mb-8 max-w-3xl mx-auto drop-shadow-md">
              Evinizin her köşesinde hijyen ve parlaklık sağlayan yenilikçi temizlik çözümleri.
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          <div className="bg-white p-6 rounded-xl shadow-md text-center">
            ...
            <h3 className="font-semibold text-lg mb-2">Yüksek Performans</h3>
            <p className="text-gray-600 text-sm">Etkili ve hızlı temizlik için güçlü cihazlar</p>
          </div>
          <div className="bg-white p-6 rounded-xl shadow-md text-center">
            <div className="w-12 h-12 rounded-full bg-green-100 flex items-center justify-center text-green-600 mb-4 mx-auto">
              <Settings className="h-6 w-6" />
            </div>
            <h3 className="font-semibold text-lg mb-2">Çok Yönlü Kullanım</h3>
            <p className="text-gray-600 text-sm">Farklı yüzeyler ve ihtiyaçlar için uygun</p>
          </div>
          <div className="bg-white p-6 rounded-xl shadow-md text-center">
            <div className="w-12 h-12 rounded-full bg-purple-100 flex items-center justify-center text-purple-600 mb-4 mx-auto">
              <Package className="h-6 w-6" />
            </div>
            <h3 className="font-semibold text-lg mb-2">Kompakt Tasarım</h3>
            <p className="text-gray-600 text-sm">Kolay saklama ve taşıma</p>
          </div>
          <div className="bg-white p-6 rounded-xl shadow-md text-center">
            <div className="w-12 h-12 rounded-full bg-orange-100 flex items-center justify-center text-orange-600 mb-4 mx-auto">
              <Star className="h-6 w-6" />
            </div>
            <h3 className="font-semibold text-lg mb-2">Kullanıcı Dostu</h3>
            <p className="text-gray-600 text-sm">Basit arayüz ve kolay kullanım</p>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-md mb-8">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-lg font-semibold">Temizlik Ürünlerini Filtrele</h2>
          </div>
        ...
        <div className="bg-gradient-to-r from-gray-50 to-blue-50 rounded-2xl p-8 md:p-12">
          <h2 className="text-3xl font-bold text-center mb-8">Temizlik Ürünleri Bakım Rehberi</h2>
