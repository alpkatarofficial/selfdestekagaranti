...
export default function SacBakimPage() {
  ...
  useEffect(() => {
    const loadProducts = async () => {
      ...
      const sacBakimProducts = allProducts.filter((p) => p.category === "sac-bakim")
      setProducts(sacBakimProducts)
      setIsLoading(false)
    }
    loadProducts()
  }, [])
      ...
      <div className="container mx-auto px-4 py-16 pt-24">
        ...
        <div className="relative mb-16 rounded-2xl overflow-hidden">
          <div className="absolute inset-0">
            <Image
              src="/images/dreame-hair-dryer.webp"
              alt="Dreame Saç Bakım Ürünleri"
              fill
          ...
          <div className="relative z-10 text-center py-24 px-8">
            <div className="inline-flex items-center justify-center bg-gray-100/90 text-gray-800 px-4 py-2 rounded-full text-sm font-medium mb-6 backdrop-blur-sm">
              ...
              Saçlarınız İçin En İyisi
            </div>
            <h1 className="text-4xl md:text-6xl font-bold mb-6 text-white drop-shadow-lg">Dreame Saç Bakım Ürünleri</h1>
            <p className="text-xl md:text-2xl text-gray-100 mb-8 max-w-3xl mx-auto drop-shadow-md">
              Saçlarınızı koruyan ve şekillendiren yenilikçi saç kurutma makineleri ve şekillendiriciler.
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          <div className="bg-white p-6 rounded-xl shadow-md text-center">
            ...
            <h3 className="font-semibold text-lg mb-2">Hızlı Kurutma</h3>
            <p className="text-gray-600 text-sm">Güçlü motorlarla hızlı ve etkili kurutma</p>
          </div>
          <div className="bg-white p-6 rounded-xl shadow-md text-center">
            <div className="w-12 h-12 rounded-full bg-green-100 flex items-center justify-center text-green-600 mb-4 mx-auto">
              <Settings className="h-6 w-6" />
            </div>
            <h3 className="font-semibold text-lg mb-2">İyonik Teknoloji</h3>
            <p className="text-gray-600 text-sm">Saçları korur ve parlaklık verir</p>
          </div>
          <div className="bg-white p-6 rounded-xl shadow-md text-center">
            <div className="w-12 h-12 rounded-full bg-purple-100 flex items-center justify-center text-purple-600 mb-4 mx-auto">
              <Package className="h-6 w-6" />
            </div>
            <h3 className="font-semibold text-lg mb-2">Akıllı Sıcaklık</h3>
            <p className="text-gray-600 text-sm">Saç hasarını önlemek için otomatik ayar</p>
          </div>
          <div className="bg-white p-6 rounded-xl shadow-md text-center">
            <div className="w-12 h-12 rounded-full bg-orange-100 flex items-center justify-center text-orange-600 mb-4 mx-auto">
              <Star className="h-6 w-6" />
            </div>
            <h3 className="font-semibold text-lg mb-2">Ergonomik Tasarım</h3>
            <p className="text-gray-600 text-sm">Kolay ve rahat kullanım</p>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-md mb-8">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-lg font-semibold">Saç Bakım Ürünlerini Filtrele</h2>
          </div>
        ...
        <div className="bg-gradient-to-r from-gray-50 to-blue-50 rounded-2xl p-8 md:p-12">
          <h2 className="text-3xl font-bold text-center mb-8">Saç Bakım Rehberi</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="font-semibold text-lg mb-2">Doğru Kullanım</h3>
              <p className="text-gray-600">Cihazınızı kullanım kılavuzuna uygun şekilde kullanarak ömrünü uzatın.</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">Cihazınızı düzenli olarak temizleyerek performansını koruyun.</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 rounded-full bg-purple-100 flex items-center justify-center text-purple-600 mb-4 mx-auto">
                <Shield className="h-8 w-8" />
              </div>
              <h3 className="font-semibold text-lg mb-2">Güvenli Saklama</h3>
              <p className="text-gray-600">Cihazınızı kuru ve güvenli bir yerde saklayın.</p>
            </div>
          </div>
        </div>
      </div>
