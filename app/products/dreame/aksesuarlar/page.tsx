...
export default function AksesuarlarPage() {
  ...
  useEffect(() => {
    const loadProducts = async () => {
      ...
      const aksesuarlarProducts = allProducts.filter((p) => p.category === "aksesuarlar")
      setProducts(aksesuarlarProducts)
      setIsLoading(false)
    }
    loadProducts()
  }, [])
  ...
  const filteredAndSortedProducts = products
    .filter((product) => {
      ...
      // `compatibleWith`, `price`, `isPopular`, `isPremium`, `isNew`, `discount`, `inStock`, `contents`, `model` gibi alanlar Product tipinde yok, bu yüzden kaldırıldı veya basitleştirildi.
      // Eğer bu alanlar veritabanında olacaksa, Product tipine eklenmeli ve filtreleme/sıralama mantığı güncellenmelidir.
      ...
      <div className="container mx-auto px-4 py-16 pt-24">
        ...
        <div className="relative mb-16 rounded-2xl overflow-hidden">
          <div className="absolute inset-0">
            <Image
              src="/images/dreame-accessories.webp"
              alt="Dreame Aksesuarlar"
              fill
          ...
          <div className="relative z-10 text-center py-24 px-8">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 text-white drop-shadow-lg">Dreame Aksesuarlar</h1>
            <p className="text-xl md:text-2xl text-gray-100 mb-8 max-w-3xl mx-auto drop-shadow-md">
              Dreame ürünlerinizin performansını korumak için orijinal yedek parçalar ve aksesuarlar. Uzun ömürlü
              kullanım için kaliteli çözümler.
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          <div className="bg-white p-6 rounded-xl shadow-md text-center">
            ...
            <h3 className="font-semibold text-lg mb-2">Orijinal Parça</h3>
            <p className="text-gray-600 text-sm">%100 orijinal ve garanti kapsamında</p>
          </div>
          <div className="bg-white p-6 rounded-xl shadow-md text-center">
            <div className="w-12 h-12 rounded-full bg-green-100 flex items-center justify-center text-green-600 mb-4 mx-auto">
              <Settings className="h-6 w-6" />
            </div>
            <h3 className="font-semibold text-lg mb-2">Kolay Montaj</h3>
            <p className="text-gray-600 text-sm">Basit ve hızlı kurulum</p>
          </div>
          <div className="bg-white p-6 rounded-xl shadow-md text-center">
            <div className="w-12 h-12 rounded-full bg-purple-100 flex items-center justify-center text-purple-600 mb-4 mx-auto">
              <Package className="h-6 w-6" />
            </div>
            <h3 className="font-semibold text-lg mb-2">Ekonomik Paket</h3>
            <p className="text-gray-600 text-sm">Uygun fiyatlı paket seçenekleri</p>
          </div>
          <div className="bg-white p-6 rounded-xl shadow-md text-center">
            <div className="w-12 h-12 rounded-full bg-orange-100 flex items-center justify-center text-orange-600 mb-4 mx-auto">
              <Star className="h-6 w-6" />
            </div>
            <h3 className="font-semibold text-lg mb-2">Uzun Ömürlü</h3>
            <p className="text-gray-600 text-sm">Dayanıklı malzeme ve yapı</p>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-md mb-8">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-lg font-semibold">Aksesuarları Filtrele</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            {/* Kategori, Uyumluluk ve Fiyat filtreleri Product tipinde olmadığı için kaldırıldı */}
            <div>
            ...
            {filteredAndSortedProducts.map((product) => (
              ...
              >
                <div className="relative">
                  ...
                  />
                  {/* isPopular, isPremium, isNew, discount, inStock gibi alanlar Product tipinde yok, bu yüzden kaldırıldı */}
                </div>
        ...
        <div className="bg-gradient-to-r from-gray-50 to-blue-50 rounded-2xl p-8 md:p-12">
          <h2 className="text-3xl font-bold text-center mb-8">Aksesuar Bakım Rehberi</h2>
