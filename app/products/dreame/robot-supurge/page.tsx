...
export default function RobotSupurgePage() {
  ...
  useEffect(() => {
    const loadProducts = async () => {
      ...
      try {
        ...
        const robotSupurgeProducts = allProducts.filter((p) => p.category === "robot-supurge")
        setProducts(robotSupurgeProducts)
      } catch (err) {
    ...
    .filter((product) => {
      const searchFilter = searchQuery
        ? product.name.toLowerCase().includes(searchQuery.toLowerCase()) ||
          ...
          product.model_name.toLowerCase().includes(searchQuery.toLowerCase()) // model_name'i de arama filtresine ekledik
        : true
      return searchFilter
    })
    .sort((a, b) => {
      switch (sortBy) {
        ...
        case "model_name": // model_name'e göre sıralama seçeneği ekledik
      ...
      <div className="container mx-auto px-4 py-16 pt-24">
        ...
        <div className="relative mb-16 rounded-2xl overflow-hidden">
          <div className="absolute inset-0">
            <Image
              src="/images/dreame-robot-vacuum.webp"
              alt="Dreame Robot Süpürgeler"
              fill
          ...
          <div className="relative z-10 text-center py-24 px-8">
            <div className="inline-flex items-center justify-center bg-gray-100/90 text-gray-800 px-4 py-2 rounded-full text-sm font-medium mb-6 backdrop-blur-sm">
              ...
              Akıllı Temizlik Çözümleri
            </div>
            <h1 className="text-4xl md:text-6xl font-bold mb-6 text-white drop-shadow-lg">Dreame Robot Süpürgeler</h1>
            <p className="text-xl md:text-2xl text-gray-100 mb-8 max-w-3xl mx-auto drop-shadow-md">
              Evinizi zahmetsizce temizleyen, akıllı navigasyon ve güçlü emiş özelliklerine sahip robot süpürgeler.
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          ...
          <div className="bg-white p-6 rounded-xl shadow-md text-center">
            ...
            <h3 className="font-semibold text-lg mb-2">Akıllı Navigasyon</h3>
            <p className="text-gray-600 text-sm">Evinizi haritalar ve en verimli rotayı bulur</p>
          </div>
          <div className="bg-white p-6 rounded-xl shadow-md text-center">
            <div className="w-12 h-12 rounded-full bg-purple-100 flex items-center justify-center text-purple-600 mb-4 mx-auto">
              <Package className="h-6 w-6" />
            </div>
            <h3 className="font-semibold text-lg mb-2">Otomatik Boşaltma</h3>
            <p className="text-gray-600 text-sm">Toz haznesini kendi kendine boşaltır</p>
          </div>
          <div className="bg-white p-6 rounded-xl shadow-md text-center">
            <div className="w-12 h-12 rounded-full bg-orange-100 flex items-center justify-center text-orange-600 mb-4 mx-auto">
              <Star className="h-6 w-6" />
            </div>
            <h3 className="font-semibold text-lg mb-2">Paspaslama Özelliği</h3>
            <p className="text-gray-600 text-sm">Hem süpürür hem paspaslar</p>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-md mb-8">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-lg font-semibold">Robot Süpürgeleri Filtrele</h2>
          </div>
            ...
            <div>
              ...
              <Select value={sortBy} onValueChange={setSortBy}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="model_name">Model Adı</SelectItem> {/* Yeni sıralama seçeneği */}
                </SelectContent>
              </Select>
            </div>
          </div>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-12 text-red-500 bg-red-50 rounded-md">
            <p>{error}</p>
            <p className="text-sm text-red-400 mt-2">
              Lütfen Supabase veritabanınızdaki 'dreames' tablosunun mevcut olduğundan ve doğru yapılandırıldığından
              emin olun.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-16">
            {filteredAndSortedProducts.map((product) => (
              ...
              >
                <div className="relative">
                  <Image
                    src={product.image_url || "/placeholder.svg"} // image_url kullanıyoruz
                    alt={product.name}
                    width={300}
                    height={300}
                ...
                <CardContent className="p-4">
                  <div className="mb-3">
                    ...
                    <p className="text-xs text-gray-500 mb-1">{product.model_name}</p> {/* model_name'i gösteriyoruz */}
        ...
        <div className="bg-gradient-to-r from-gray-50 to-blue-50 rounded-2xl p-8 md:p-12">
          <h2 className="text-3xl font-bold text-center mb-8">Robot Süpürge Bakım Rehberi</h2>
