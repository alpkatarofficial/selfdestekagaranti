...
interface PhilipsClientPageProps {
  products: Product[]
}
...
export default function PhilipsClientPage({ products }: PhilipsClientPageProps) {
      ...
      {filteredProducts.length > 0 ? (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {filteredProducts.map((product) => (
            <Link key={product.id} href={`/products/philips/${product.id}`} className="group">
